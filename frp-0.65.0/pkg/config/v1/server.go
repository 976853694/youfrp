...
type ServerConfig struct {
	...
	John_San_Api string `json:"John_San_Api,omitempty"`
	John_San_Token string `json:"John_San_Token,omitempty"`
...
func (c *ServerConfig) Complete() error {
	...
	c.John_San_Api = util.EmptyOr(c.John_San_Api, "http://frpapi.demo.com")
	c.John_San_Token = util.EmptyOr(c.John_San_Token, "john_san_frps_token|1")
